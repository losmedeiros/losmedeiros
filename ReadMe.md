...
- Tenho mais de 10 anos de experiência na área de manutenção de Máquinas Industriais. Ao longo desses anos, Venho Desenvolvendo meu trabalho nos setores de mineração, Industria e Hospitalar. No momento, estou em transição de carreira.  <br><br>Celular: 83996691186 zap<br>losmedeiros@gmail.com <br><br>📚 Estou graduando em Sistemas de Informação, explorando as nuances da análise de dados, arquitetura de sistemas e desenvolvimento de softwares. 
<br><br> Minha área de predileção é o desenvolvimento em Java com Spring Boot. Estou entusiasmado em contribuir para projetos desafiadores e aplicar meu conhecimento para impulsionar inovações. Estou aberto a oportunidades que permitam explorar minha paixão pela tecnologia e aprimorar minhas habilidades em desenvolvimento de software.<br><br>🤝 Estou sempre aberto a conectar-me com colegas de setor, entusiastas de tecnologia e profissionais que compartilham o mesmo zelo pela excelência e aprendizado contínuo. Desde já, eu agradeço a você ter visitado meu perfil profissional, visitado minha experiência. Ademais, não deixe de se conectar comigo, um forte abraço e boa sorte.<br><br>- 🎓 Formações Acadêmicas:<br>* Técnico em Eletrônica industrial;<br>* Tecnólogo em Analise e desenvolvimento de sistemas;<br>* Especialização, Pós graduação em Engenharia de Controle e Automação.<br>* Cursando: Bacharelado em Sistemas de informação.<br><br><br>- 👨‍💻 Estudando.<br>* Java;<br>* Angular;<br>* Spring boot;<br>* JavaScript;<br>* Node.js;
